...
exports.getdashboard = asyncError(async (req, res) => {
  ...
  let totalOrders = 0;
  let totalIncome = 0;
  recentOrders.forEach((order, i = 1) => {
                      ...
                      <tr>
                          <td align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 10px;">
                              <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777;">
                               Dear ${order.shippingInfo.firstname}! Your $${order.totalPrice} order is ready for pickup. Feel free to pickup within 14 days of this email.
              ...
              <tr>
                  ...
                  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                      ...
                      <tr>
                          <td align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 10px;">
                              <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777;">
                               Dear ${order.shippingInfo.firstname}! Your order with the following order number: <b>${order._id}</b>
...
exports.allBlogs = asyncError(async (req, res) => {
  const blogs = await Blog.find();
  res.render("dashboard/allBlogs", { blogs, classes: "blogs" });
});
exports.allcategories = asyncError(async (req, res) => {
  const categories = await Category.find();
  res.render("dashboard/allCategories", { categories, classes: "categories" });
});
exports.allemployees = asyncError(async (req, res) => {
